(function(){
  'use strict';
  var mMain = angular.module('mMain',
  ...
  mMain.factory('Auth', ['Base64', '$cookieStore', '$http', function (Base64, $cookieStore, $http) {
  ...
  mMain.directive('authentication', function() {
    return {
      restrict: 'C',
  ...
  mMain.controller('IndexCtrl', ['$scope','$location','$http','breadcrumbs', function($scope,$location,$http,breadcrumbs){
  ...
  mMain.controller('MainCtrl', ['$scope','$http',function($scope,$http){}]);
  mMain.controller(
    'LoginCtrl',
    ['$scope','$http','authService','Base64','Auth','$cookieStore',
     function ($scope,$http,authService,Base64,Auth,$cookieStore) {
       ...
       $http.get(ztds.resources.login).success(function(result) {});
  ...
  mMain.config(['$routeProvider','$httpProvider',function($routeProvider,$httpProvider) {
    $routeProvider.
      when('/', {
